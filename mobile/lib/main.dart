...
class _MyHomePageState extends State<MyHomePage> {
  ...
  late Future<String> helloResponse;
  ...
  void initState() {
    ...
    helloResponse = api.helloWorldRequestDart();
  }
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            FutureBuilder<List<dynamic>>(
              ...
              // List<dynamic>.
              future: Future.wait([platform, isRelease, helloResponse]),
              builder: (context, snap) {
                ...
                final text = const {
                    ...
                    'Unknown OS';
                return Text('$text ($release): $helloResponseTxt', style: style);
              },
            )
          ],
        ),
